...
public class ManageEventFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        // Delete Event
        deleteEventButton.setOnClickListener(view -> db.collection("events").document(eventId).delete().addOnSuccessListener(unused -> {
            StorageReference storageReference = storage.getReference().child("QRCodes/" + eventId + ".png");

            storageReference.delete().addOnSuccessListener(unused1 -> Toast.makeText(getContext(), "Event successfully deleted!", Toast.LENGTH_SHORT).show()).addOnFailureListener(e -> Toast.makeText(getContext(), "Error: Failed to delete QR Code from storage!", Toast.LENGTH_SHORT).show());
        ...
        deleteQRCodeButton.setOnClickListener(view -> {
            ...
            db.collection("events").document(eventId).update("QRCodeUrl", "")
                    .addOnSuccessListener(aVoid -> {
                        ...
                        StorageReference storageReference = storage.getReference().child("QRCodes/" + eventId + ".png");
                        storageReference.delete().addOnSuccessListener(unused1 -> Toast.makeText(getContext(), "Event QR Code successfully deleted!", Toast.LENGTH_SHORT).show()).addOnFailureListener(e -> Toast.makeText(getContext(), "Error: Failed to delete QR Code from storage!", Toast.LENGTH_SHORT).show());

                    })
                    .addOnFailureListener(e -> Toast.makeText(getContext(), "Error: Failed to clear QRCodeUrl field!", Toast.LENGTH_SHORT).show());
        });
